...
INSERT INTO `Little Lemon Database`.`CustomerDetails` (`Name`, `ContactDetail`)
VALUES
...
INSERT INTO `Little Lemon Database`.`StaffInformation` (`Name`, `Role`, `Salary`)
VALUES
('Sarah', 'Manager', 55000),
('Tom', 'Waiter', 30000),
('Linda', 'Chef', 40000),
...
INSERT INTO `Little Lemon Database`.`Menus` (`Name`, `Type`, `Price`)
VALUES
...
INSERT INTO `Little Lemon Database`.`Bookings` (`CustomerID`, `StaffID`, `Date`, `TableNumber`)
VALUES
...
INSERT INTO `Little Lemon Database`.`Orders` (`CustomerID`, `MenuItemID`, `StaffID`, `Date`, `Quantity`, `TotalCost`)
VALUES
...
INSERT INTO `Little Lemon Database`.`OrderDeliveryStatuses` (`OrderID`, `Date`, `Status`)
VALUES
